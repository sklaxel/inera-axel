...
public class ShsRivAdminNavigationProvider implements NavigationProvider {
	...
	public List<Link<Page>> getItems(String componentId, String labelId) {
		...
		links.add(createPageLink(componentId, labelId, RivShsServiceMappingsPage.class, "RIV/SHS"));
