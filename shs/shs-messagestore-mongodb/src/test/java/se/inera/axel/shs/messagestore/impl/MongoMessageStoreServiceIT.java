...
import static se.inera.axel.shs.messagestore.impl.MongoMessageStoreEntryMaker.MongoMessageStoreEntry;
...
public class MongoMessageStoreServiceIT extends
	...
	public void testSave() {
        final ShsMessageEntry entry = make(a(MongoMessageStoreEntry));
        final se.inera.axel.shs.protocol.ShsMessage shsMessage = make(a(ShsMessage));
    ...
    public void deletingNonExistingFileShouldBeANoOp() {
        messageStore.delete(make(a(MongoMessageStoreEntry)));
    ...
    public void findOneSavedEntry() {
        se.inera.axel.shs.protocol.ShsMessage message = messageStore.findOne(entry1);
	...
	public void beforeMethod() {
        mongoOperations.execute(new DbCallback<Object>() {
            ...
            public Object doInDB(DB db) throws MongoException, DataAccessException {
                ...
                entry1 = make(a(MongoMessageStoreEntry));
