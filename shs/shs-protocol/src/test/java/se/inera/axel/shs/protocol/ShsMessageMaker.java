...
public class ShsMessageMaker {
	...
	public static class ShsMessageInstantiator implements Instantiator<ShsMessage> {
		public static final Property<ShsMessage, ShsLabel> label = newProperty();
		public static final Property<ShsMessage, List<DataPart>> dataParts = newProperty();
